<template>
  <div class="text-center" v-if="isReady">
    <my-q-img contain v-if="data[typeName] === 'practice_ticket' && data[idName] <=4" class="resource-img"
    :src="`/assets/jp/thumb/common_rip/practiceticket${data[idName]}.webp`" />
    <my-q-img contain v-else-if="data[typeName] === 'practice_ticket'" class="resource-img"
    :src="`/assets/jp/thumb/common_rip/skillticket_${data[idName]}.webp`" />
    <my-q-img contain v-else-if="data[typeName] === 'item'" class="resource-img"
    :src="`/assets/jp/thumb/material_rip/material${String(data[idName]).padStart(3, '0')}.webp`" />
    <my-q-img contain v-else-if="data[typeName] === 'stamp'" class="resource-img"
    ...
    <my-q-img contain v-else class="resource-img"
