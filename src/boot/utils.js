...
export default ({ app, router, Vue }) => {
  ...
  Vue.specialCardList = Vue.prototype.$specialCardList = {
    jp: [],
    tw: [5001, 5002, 5003, 5004, 5005, 5006],
    kr: [],
    en: [10001, 10002, 10003, 10004, 10005, 10006, 10007, 10008, 10009, 10010],
    cn: [10000, 10001, 10002, 10003, 10004, 10005, 10006, 10007, 10008]
  }
}
